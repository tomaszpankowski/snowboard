...
class MessageSent extends Component {
    ...
    render() {
        return (
            <Container fluid className={"contact-s2 align-items-center px-0 py-5 border-top border-dark bg-white d-flex minh-100vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={10} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Card className="mx-auto border-secondary shadow opacity-9">
