...
class LoginForm extends Component{
    ...
    render(){
        return(        
            <Container fluid className={"login-s1 align-items-center p-0 py-5 border-top border-dark d-flex minh-100vh "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={5} lg={4} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 opacity-9 border border-secondary p-4 rounded bg-light shadow text-secondary fw-bold"
                            autoComplete="off"
                            method="POST">
